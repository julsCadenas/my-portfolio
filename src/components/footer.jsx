...
const Footer = () => {
    ...
    return (
        <footer className="h-screen flex justify-center items-center flex-col bg-black text-white font-Poppins space-y-1" id="footer">
            ...
            <div className="flex items-center space-x-3 lg:space-x-5 text-7xl lg:text-9xl">
                ...
                <a href="mailto:jscadenas12@gmail.com" target='_blank'><span className="material-symbols-outlined text-8xl lg:text-[160px] font-semibold hover:scale-110 transition-all">mail</span></a>
            </div>
            ...
            <a href="#" onClick={scrollUp} className=''><span className="material-symbols-outlined text-7xl lg:text-9xl font-bold mt-5 hover:scale-125 transition-all">keyboard_arrow_up</span></a>
        </footer>
    );
};
